...
public class Regra implements Serializable {
    ...
    public Regra(String dataIni, String dataFim, int pontoMinimo, int anosConsiderados, double multiplicador,
        ...
        this.dataIni = new GregorianCalendar(Integer.parseInt(dataIniSplit[2]), Integer.parseInt(dataIniSplit[1]) - 1,
                Integer.parseInt(dataIniSplit[0]));
        this.dataFim = new GregorianCalendar(Integer.parseInt(dataFimSplit[2]), Integer.parseInt(dataFimSplit[1]) - 1,
    ...
    public String toString() {
        return "Regra [dataIni=" + this.dataIni + ", dataFim=" + this.dataFim + ", pontoMinimo=" + this.pontoMinimo
                + ", anosConsiderados=" + this.anosConsiderados + ", multiplicador=" + this.multiplicador + ", qualis="
                + this.qualis + "]";
    }
}
